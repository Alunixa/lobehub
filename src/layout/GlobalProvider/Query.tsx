...
const QueryProvider = ({ children }: PropsWithChildren) => {
  ...
  useLayoutEffect(() => {
    ...
    // data until an incidental revalidation. SWRMutateInitializer observes the
    // hydration-ready event and revalidates every mounted consumer after the
    // swap; the CacheHydrationGate latch keeps the tree mounted.
    void reloadScope()
      .catch((error) => {
