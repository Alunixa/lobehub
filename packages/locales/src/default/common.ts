export default {
  ...
  'mobile.conversationActions': 'Conversation actions',
  'mobile.conversationHistory': 'Open conversation history',
  'mobile.conversations': 'Conversations',
  'mobile.conversationsDescription': 'Your assistants, ready where you left off',
  'mobile.createFailed': 'Could not create the assistant. Please try again.',
  'mobile.createImage': 'Create images',
  'mobile.darkTheme': 'Switch to dark theme',
  'mobile.discoverDescription': 'Find assistants, models and tools',
  'mobile.imageDescription': 'Create, refine and browse your images',
  'mobile.lightTheme': 'Switch to light theme',
  'mobile.memoryDescription': 'Manage what your assistants remember',
  'mobile.navigation': 'Main navigation',
  'mobile.newAgent': 'New assistant',
  'mobile.newConversation': 'New conversation',
  'mobile.noSettingsFound': 'No settings match your search',
  'mobile.providersDescription': 'Connect providers and manage models',
  'mobile.saved': 'Saved',
  'mobile.saveFailed': 'Changes could not be saved. Retry before leaving this page.',
  'mobile.saving': 'Saving…',
  'mobile.searchSettings': 'Search settings',
  'mobile.settings': 'Settings',
  'mobile.settingsDescription': 'Account, appearance, models and app preferences',
  'mobile.tasks': 'Tasks',
  'mobile.tasksDescription': 'Follow running tasks and manage schedules',
  'mobile.workbench': 'Workbench',
  'mobile.workbenchDescription': 'Everything you need beyond a conversation',
  'mobile.workspaceSettings': 'Workspace settings',
  'mobile.yourAgents': 'Your assistants',
  'about': 'About',
