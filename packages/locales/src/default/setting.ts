export default {
  'settingCommon.currentTime.title': 'Include current date and time in every AI request',
  'settingCommon.currentTime.desc':
    'Off by default. When enabled, every model request includes a fresh date, weekday and time to the minute, with timezone {{timezone}}. The current-time skill can query live seconds independently.',
  'settingCommon.currentTime.saveFailed': 'Could not save. Please try the switch again.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.advanced.automaticUpdates.desc':
    'Periodically check for and download updates in the background. Manual update checks remain available when this is off.',
  'tab.advanced.automaticUpdates.loadError': 'Failed to load automatic update settings',
  'tab.advanced.automaticUpdates.saveError': 'Failed to save automatic update settings',
  'tab.advanced.automaticUpdates.title': 'Automatic updates',
