export default {
  ...
  'builtins.lobe-page-agent.apiName.editTitle.result':
  ...
  'builtins.lobe-page-agent.apiName.modifyNodes.result':
  ...
  'builtins.lobe-skills.apiName.getCurrentTime': 'Get Current Date and Time',
  ...
  'builtins.lobe-self-feedback-intent.apiName.declareSelfFeedbackIntent':
  ...
  'detailModal.emptyState.description':
    'Install this Skill to view its capabilities and settings',
  ...
  'dev.mcp.args.desc':
    'Arguments passed to the command, usually MCP server name or script path',
  ...
  'protocolInstall.messages.installSuccess':
    '{{name}} installed. Enable now or configure later.',
