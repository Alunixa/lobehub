...
/** A projected concrete window, keyed by (limitKind, scopeKey, resetsAt). */
 ...
 */
export const windowSecondsForKind = (limitKind: string): number =>
  limitKind.startsWith('weekly') ? CLAUDE_WEEKLY_WINDOW_SECONDS : CLAUDE_SESSION_WINDOW_SECONDS;
